...
![Mecanum drive wheel arrangement](/api/lesson-asset/02-teleop-control/03-mecanum-drive/mecanum-drive-directions.png)

The roller direction on each wheel determines its contribution to movement. This specific arrangement is what enables omnidirectional movement.

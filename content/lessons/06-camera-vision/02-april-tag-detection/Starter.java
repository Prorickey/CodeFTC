...
public class StudentCode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // TODO: Get the list of detections from aprilTag.getDetections()

        // TODO: Loop through each detection and display to telemetry:
        //   telemetry.addData("Tag ID",        detection.id);
        //   telemetry.addData("Range (in)",    "%.1f", detection.ftcPose.range);
        //   telemetry.addData("Bearing (deg)", "%.1f", detection.ftcPose.bearing);

        // TODO: Call telemetry.update() once after the loop
